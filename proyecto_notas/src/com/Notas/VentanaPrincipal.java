...
public class VentanaPrincipal extends JFrame implements ActionListener{
    ...
    private void inicio(){
        ...
        nota1.setBounds(20, parametro, 135, 23);
        campoNota1 = new JTextField();
        campoNota1.setBounds(105, parametro, 135, 23);

        nota2 = new JLabel();
        nota2.setText("Nota 2:");
        nota2.setBounds(20, parametro+30, 135, 23);
        campoNota2 = new JTextField();
        campoNota2.setBounds(105, parametro+30, 135, 23);

        nota3 = new JLabel();
        nota3.setText("Nota 3:");
        nota3.setBounds(20, parametro+2*30, 135, 23);
        campoNota3 = new JTextField();
        campoNota3.setBounds(105, parametro+2*30, 135, 23);

        nota4 = new JLabel();
        nota4.setText("Nota 4:");
        nota4.setBounds(20, parametro+3*30, 135, 23);
        campoNota4 = new JTextField();
        campoNota4.setBounds(105, parametro+3*30, 135, 23);

        nota5 = new JLabel();
        nota5.setText("Nota 5:");
        nota5.setBounds(20, parametro+4*30, 135, 23);
        campoNota5 = new JTextField();
        campoNota5.setBounds(105, parametro+4*30, 135, 23);
    ...
    public void actionPerformed(ActionEvent evento){
        ...
        if(evento.getSource() == calcular){
            ...
            promedio.setText("Promedio = " + String.valueOf(String.format("%.2f",notas.promedio())));
            desviacion.setText("Desviacion = " + String.valueOf(String.format("%.2f",notas.desviacion_estandar())));
            mayor.setText("Mayor nota = " + String.valueOf(String.format("%.2f",notas.mayor_nota())));
            menor.setText("Menor nota = " + String.valueOf(String.format("%.2f",notas.menor_nota())));
        }
